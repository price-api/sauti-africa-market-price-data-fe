	...
	return (
		<div className='playground'>
			<form className='playForm'>
				...
				<Input className='playURL' name='url' type='text' value={userAnswer.url} onChange={handleChange} />
				<Button onClick={(e) => clearUrl(e)}>Clear URL</Button>
			</form>
			<small>pagination disabled for playground</small>
			<div>
				<Button className='playBtn' disabled={disabledBtn} onClick={(e) => handleSubmit(e, userAnswer.url)}>
					make your call!
				</Button>
			</div>
			{data[0] && !bad ? (
